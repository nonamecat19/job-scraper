...
func (d Source) requestURL(subURL string) string {
...
func (d Source) FetchDetail(ctx context.Context, jobURL string, _ map[string]any) (RemoteOKDetailPatch, error) {
	body, err := d.Scraping.FetchHTML(ctx, d.apiURL(), map[string]string{"User-Agent": remoteokUserAgent})
	if err != nil {
