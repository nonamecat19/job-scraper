...
func (WorkUaAdapter) Kind() model.SourceKind { return model.SourceKindScrape }

func (WorkUaAdapter) NeedsDetail() bool { return true }

func (d WorkUaAdapter) Search(ctx context.Context, query model.SearchQuery, config map[string]any) ([]model.NormalizedJob, error) {
...
func (d WorkUaAdapter) scrapeWorkUaSubscription(ctx context.Context, subURL string) ([]model.NormalizedJob, error) {
