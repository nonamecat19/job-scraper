...
func (ManualAdapter) Kind() model.SourceKind { return model.SourceKindManual }

func (ManualAdapter) Search(context.Context, model.SearchQuery, map[string]any) ([]model.NormalizedJob, error) {
