...
func (IndeedAdapter) Kind() model.SourceKind { return model.SourceKindScrape }
...
func (d IndeedAdapter) Search(ctx context.Context, query model.SearchQuery, _ map[string]any) ([]model.NormalizedJob, error) {
...
func (d IndeedAdapter) scrapeSubscription(ctx context.Context, subURL string) ([]model.NormalizedJob, error) {
