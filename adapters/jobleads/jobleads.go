...
func (Source) UsesUserAccount() bool { return true }
...
func (d Source) HealthCheck(ctx context.Context, config map[string]any) (bool, error) {
	...
	doc, err := d.fetchDoc(ctx, BaseURL+"/job-search", headers)
	if err != nil {
		return false, nil
	}
	return doc != nil, nil
...
func (d Source) FetchDetail(ctx context.Context, jobURL string, _ map[string]any) (JobLeadsDetailPatch, error) {
	headers, err := d.authHeaders(ctx)
	if err != nil {
