...
func (JoobleAdapter) Kind() model.SourceKind { return model.SourceKindAPI }
...
func (a JoobleAdapter) Search(ctx context.Context, query model.SearchQuery, config map[string]any) ([]model.NormalizedJob, error) {
