...
func (ArbeitnowAdapter) Kind() model.SourceKind { return model.SourceKindAPI }

func (ArbeitnowAdapter) Search(ctx context.Context, query model.SearchQuery, config map[string]any) ([]model.NormalizedJob, error) {
