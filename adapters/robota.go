...
func (RobotaAdapter) Kind() model.SourceKind { return model.SourceKindAPI }

func (a RobotaAdapter) Search(ctx context.Context, query model.SearchQuery, config map[string]any) ([]model.NormalizedJob, error) {
...
func (a RobotaAdapter) mapJobs(vacancies []robotaVacancy) []model.NormalizedJob {
