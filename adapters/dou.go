...
func (DouAdapter) Kind() model.SourceKind { return model.SourceKindScrape }
...
func (d DouAdapter) Search(ctx context.Context, query model.SearchQuery, config map[string]any) ([]model.NormalizedJob, error) {
...
func (d DouAdapter) Fetch(ctx context.Context, jobURL string) (model.NormalizedJob, error) {
...
func (d DouAdapter) scrapeSubscription(ctx context.Context, subURL string) ([]model.NormalizedJob, error) {
...
func (d DouAdapter) fetchDOUXHRPage(ctx context.Context, xhrURL, csrfToken, afterID string, logger *slog.Logger) ([]model.NormalizedJob, string, error) {
	form := url.Values{}
